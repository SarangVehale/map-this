...
def create_crime_rate_map(states_geojson, crime_data, police_stations_data, 
                         selected_state, selected_district, selected_police_station):
    """
...
def main():
    # Set up the page configuration for full-width layout
    st.set_page_config(
    ...
    # Main title in a container for better spacing
    with st.container():
