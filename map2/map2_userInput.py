...
# Main function
def main():
    parser = argparse.ArgumentParser(description="Generate a map with markers from coordinates.")
    ...
    print("\nMap saved as 'generated_map.html'. Open this file in a browser to view the map.")
